 ...
 * @return 1
 */
int VFH::Update_VFH( double laser_ranges[361][2],
                               int current_speed,
 ...
 */
float VFH::Delta_Angle(int a1, int a2)
{
 ...
 * @return the difference
 */
float VFH::Delta_Angle(float a1, float a2)
{
  float diff;
 ...
 * @return 1
 */
int VFH::Calculate_Cells_Mag( double laser_ranges[361][2], int speed )
{
  int x, y;
 ...
 * @return 1
 */
int VFH::Build_Primary_Polar_Histogram( double laser_ranges[361][2], int speed )
{
  int x, y;
  unsigned int i;
